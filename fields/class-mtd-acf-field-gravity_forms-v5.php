...
if ( !class_exists('mtd_acf_field_gravity_forms') ) {


class mtd_acf_field_gravity_forms extends acf_field {
	/*
	*  __construct
	*
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		$this->label = __('MTD Gravity Forms', 'mtd');
		...
		*/
		$this->l10n = array(
			'error' => __('Error! Please enter a higher value', 'mtd'),
		);
...
//			'label'        => __('Forms','mtd'),
//			'instructions' => __('Gravity Forms','mtd'),
//			'type'         => 'select',
//			'name'         => 'gravity_forms',
//			'choices'      => $this->forms,
//			'layout'       => 'horizontal'
	...
	function render_field( $field ) {
		...
		*/
		if ( in_array( 'gravityforms/gravityforms.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
			...
			if ( empty( $gforms ) ) {
				$gforms = __( 'No contact forms were found. Create a new form first.', 'mtd' );
			}
			...
			?>
			<p>Plugin "Gravity Forms" is not installed.</p>
			<?php
		}
	}
...
// initialize
new mtd_acf_field_gravity_forms( $this->settings );
