...
if( !class_exists('mtd_acf_field_cf7_forms') ) :


class mtd_acf_field_cf7_forms extends acf_field {
	/*
	*  __construct
	*
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		$this->label = __('MTD Contact Form 7', 'mtd');
...
//			'label'        => __('Forms','mtd'),
//			'instructions' => __('Contact Forms','mtd'),
//			'type'         => 'select',
//			'name'         => 'cf7_forms',
//			'choices'      => $this->forms,
//			'layout'       => 'horizontal'
...
// initialize
new mtd_acf_field_cf7_forms( $this->settings );
